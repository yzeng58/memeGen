...
from configs import support_llms, support_eval_datasets, description_prompt, image_size_threshold, get_dataset_dir
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, required=True, choices=list(support_eval_datasets.keys()))
