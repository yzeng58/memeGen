def load_dataset(
    ...
    elif dataset_name == 'basic':
        from load_datasets.load_basic import load_basic
        return load_basic(description=description, train_test_split=train_test_split)
    ...
    elif dataset_name == "advanced":
        from load_datasets.load_advanced import load_advanced
        return load_advanced(
            description=description, 
            train_test_split=train_test_split, 
            difficulty=difficulty,
            score_analysis=score_analysis,
