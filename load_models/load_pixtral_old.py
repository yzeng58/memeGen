...
def process_sample_feature(
    ...
    for i, image_path in enumerate(image_paths):
        ...
        if description:
            content.append(TextChunk(text=f"Meme{idx_str}: {read_json(image_path)['description']['output']}"))
        elif context:
            content.append(TextChunk(text=f"Meme{idx_str}: {read_json(image_path['description_path'])['description']['output']}"))
